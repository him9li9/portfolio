          ...
          <div className="flex flex-col gap-space-3 md:grid md:grid-cols-3">
            <div className="flex flex-col items-start gap-space-4 rounded-[20px] bg-card p-space-6 md:min-w-0">
              <div className="flex h-[38px] w-full items-center gap-space-3">
                <div className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full bg-elevated-accent text-h4 text-primary">
                  1
                </div>
          ...
          <div className="case-content-stack">
            <div className="flex flex-col gap-space-6 text-body-18">
              <div className="case-point-stack gap-space-6">
                ...
                <p>
                  Объединила поиск сценария, создание и настройку элементов и публикацию в одном рабочем
                  пространстве, убрав переключение между экранами.
                </p>
              </div>
              <div className="case-point-stack gap-space-6">
                <p className="text-body-18-semibold">Self-service</p>
                <p>
                  Сделала изменения доступными без участия разработки — менеджер получил возможность
                  самостоятельно работать со сценарием от создания до публикации.
                </p>
              </div>
              <div className="case-point-stack gap-space-6">
                <p className="text-body-18-semibold">Меньше ошибок</p>
                <p>
                  За первые 3 месяца после изменений количество ошибок на продакшене снизилось в 2,5
                  раза.
                </p>
              </div>
            </div>
            ...
            <p className="text-body-18">
              После запуска продолжила развивать редактор с учётом реальных клиентских сценариев:
              расширила библиотеку элементов, доработала масштабирование и версионность.
            </p>
          </div>
        </motion.section>
