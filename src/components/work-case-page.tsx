          ...
          <div className="case-content-stack">
            <div className="flex flex-col gap-space-6 text-body-18">
              <div className="case-point-stack gap-space-6">
                ...
                <p>
                  Объединила поиск сценария, редактирование схемы, настройку элементов и публикацию в
                  одном рабочем пространстве. Менеджеру больше не нужно переключаться между экранами.
                </p>
              </div>
              <div className="case-point-stack gap-space-6">
                <p className="text-body-18-semibold">Self-service</p>
                <p>
                  Сделала типовые изменения доступными без участия разработки — менеджеры смогли
                  самостоятельно редактировать элементы сценария и публиковать новую версию.
                </p>
              </div>
              <div className="case-point-stack gap-space-6">
                <p className="text-body-18-semibold">−21% ошибок</p>
                <p>
                  Снизила количество ошибок и случайных изменений на продакшене за счёт разделения
                  черновика и опубликованной версии.
                </p>
              </div>
            </div>

            <p className="text-body-18">
              После запуска редактор продолжили развивать на клиентских кейсах: расширяли библиотеку
              элементов, дорабатывали работу с большими схемами и тестирование сценария до публикации.
              В результате менеджер получил инструмент, в котором может самостоятельно пройти весь
              цикл работы со сценарием — от создания и редактирования до публикации.
            </p>
          </div>
        </motion.section>
