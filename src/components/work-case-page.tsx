      ...
      >
        ...
        >
          ...
          <div className="case-content-stack">
            ...
            <p className="text-body-18">
              После запуска редактор продолжили развивать на клиентских кейсах: добавляли новые элементы,
              улучшали работу с большими схемами и тестирование. В результате менеджер получил инструмент
              для самостоятельной работы со сценарием — от создания до публикации.
            </p>
          </div>
        </motion.section>
