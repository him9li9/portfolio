          ...
          <div className="case-content-stack">
            <div className="flex flex-col gap-space-6 text-body-18">
              ...
              <div className="case-point-stack gap-space-6">
                ...
                <p>
                  Снизила количество ошибок на продакшене в 2,5 раза за счёт разделения черновика и
            ...
            <p className="text-body-18">
              После запуска я продолжила развивать редактор на клиентских кейсах: расширяла библиотеку
              элементов, работала над масштабированием схем и версионностью.
            </p>
          </div>
        </motion.section>
