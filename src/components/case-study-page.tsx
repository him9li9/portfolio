    ...
    <main className="overflow-x-hidden bg-primary text-primary">
        ...
        <div className="flex h-full w-full items-center justify-between px-space-4 py-space-3 sm:px-space-8">
          ...
          <div className="flex items-center gap-space-2">
            <motion.a
              ...
              href="https://drive.google.com/file/d/1jXFLR65AUPIRSsSU4JpdDGOdRiS_aMF4/view?usp=sharing"
              target="_blank"
      ...
      >
        ...
        >
          ...
          <div
            ref={heroPhonesRef}
            className="case-horizontal-scroll case-visual-spacing relative left-1/2 w-screen -translate-x-1/2 overflow-x-auto sm:flex sm:w-[800px] sm:items-center sm:justify-center sm:overflow-visible"
          >
        ...
        >
          <div className="case-h3-stack case-h3-offset">
            ...
            <p className="text-body-18">
              ...
              команде отвечала за пользовательский путь от регистрации до первого звонка, подключение
          ...
          <div className="case-h3-stack case-h3-offset">
            ...
            <div className="case-text-stack text-body-18">
              <p>
                В первой версии продукта ключевой путь пользователя был разорван между мобильной и веб-
              ...
              <p>
                Даже после подключения путь оставался непрозрачным: пользователь не видел стоимость
                звонка заранее, не всегда понимал причину ошибки и не мог быстро найти помощь внутри
                приложения.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="case-content-stack">
            ...
            <div className="case-visual-spacing -mx-space-4 bg-[#1c1c1c] px-space-4 py-space-8 sm:mx-0 sm:rounded-[12px]">
            ...
            <div className="text-body-18">
              <p>
                <span className="text-body-18-semibold">Взяла в работу:</span> сохранять сценарий внутри
                приложения, показывать статус подключения и явно вести пользователя к следующему
                действию.
              </p>
            </div>
        ...
        >
          ...
          <div className="case-content-stack">
            ...
            <div className="case-visual-spacing relative left-1/2 flex w-screen max-w-[1000px] -translate-x-1/2 flex-col items-center justify-center sm:w-[calc(100vw-32px)]">
        ...
        >
          ...
          <div className="case-numbered-point-media case-numbered-point-media-captioned case-visual-spacing relative left-1/2 flex w-[calc(100vw-32px)] max-w-[950px] -translate-x-1/2 flex-col items-center justify-center gap-space-1">
            <div
          ...
          <div className="case-numbered-point-media case-numbered-point-media-captioned case-visual-spacing relative left-1/2 flex w-screen max-w-[1100px] -translate-x-1/2 items-center justify-center pl-space-4 sm:w-[calc(100vw-32px)] sm:pl-0">
