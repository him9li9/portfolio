    ...
    <main className="overflow-x-hidden bg-primary text-primary">
      ...
      >
        ...
        >
          ...
          <div
            ref={heroPhonesRef}
            className="relative left-1/2 w-screen -translate-x-1/2 overflow-x-auto pb-[6px] sm:flex sm:w-[800px] sm:items-center sm:justify-center sm:overflow-visible sm:pb-0"
          >
          ...
          <div className="case-content-stack">
            ...
            <div className="relative left-1/2 flex w-screen -translate-x-1/2 flex-col items-center justify-center pl-space-4 sm:w-[calc(100vw-32px)] sm:max-w-[800px] sm:pl-0">
              <div className="case-figure-stack w-full items-center gap-[6px] sm:gap-space-3">
                <div className="w-full overflow-x-auto pb-[6px] sm:overflow-visible sm:pb-0">
        ...
        >
          ...
          <div className="relative left-1/2 flex w-screen max-w-[1100px] -translate-x-1/2 items-center justify-center pl-space-4 sm:w-[calc(100vw-32px)] sm:pl-0">
            <div className="w-full">
              <div className="overflow-x-auto pb-[6px] sm:overflow-visible sm:pb-0">
